...
filename.raw=['131210_7986_MovingObjects_5.bin']; % Raw data file
filename.kilosortOutput=['131210_05_sorted.mat']; %including structure s and trial_spikes, trial_cluster
...
% m.pdthr = get_ch_thr(filename.raw,m.nChans,m.pdch,5e5,'pd',m.pd_f,3e3,0,0);
m.pdthr = 3e3;
...
%% Save pre-Rastor
% save(['131210_05_sorted','_preRaster'])
...
%% Save post-Rastor
% save(['131210_05_sorted','_postRaster'])
...
% alpha 0.5
numBins = 20; % Number of bins for each dimensions
