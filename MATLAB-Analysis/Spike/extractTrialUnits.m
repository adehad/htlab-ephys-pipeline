function extractUnitsFileName = extractTrialUnits(sortedType,files,csvName,clusterType)
%%% COPY PASTE JOB FOR NOW
% sortedType = klusta or kilosort
% files = list of files ? maybe not needed
...
elseif sortedType == 'klusta'
    ...
    warning(['sortedType provided does not match the accepted :', newline, ...
