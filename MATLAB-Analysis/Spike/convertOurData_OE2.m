...
%
% INPUT: dataFolderName (folder with the OpenEphys Data e.g.  .continuous)
...
%        concatCh       (dataRAW channels followed by adc channels)
%
...
% You MUST end the folder names with the folder separator    
    ...
    dataFolderName = ['181108','\']; % You need the '\'
...
namePart1 = dataFolderName; 
    namePart1 = namePart1(namePart1 ~= '\'); namePart1(namePart1 ~= '/');
namePart1b = '_padded';
namePart1c = '_concat';
namePart2 = '.bin';
    % DATA FILE
newFileName = [ namePart1, namePart2 ];
newFileNameINTERLACED = [ namePart1, namePart1b, namePart2 ];
newFileNameCONCAT = [ namePart1, namePart1c, namePart2 ];
    % ADC FILE
