...
srcDir=$HOME/data/test # Folder where your data is / master_XYZ.m is
...
FILEPATH=$TMPDIR
FILENAME="master_file_example_MOVEME" 	# Assume you are already in the $TMPDIR
...
# Copies processed data to srcDir
 ...
 # Removes the extra stuff we copied
  rm -rf $srcDir/KiloSort/
  rm -rf $srcDir/npy-matlab/