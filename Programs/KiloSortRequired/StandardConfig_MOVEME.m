...
ops.fbinary             = '181017_merged_converted.bin'; % will be created for 'openEphys'		
...
ops.Nfilt               = 4;           % number of clusters to use (2-4 times more than Nchan, should be a multiple of 32)     		
...
ops.chanMap             = 'chanMap-1x4(1).mat'; % make this file using createChannelMapFile.m		
...
ops.lam              = [15 30 40];   % large means amplitudes are forced around the mean ([10 30 30])		
